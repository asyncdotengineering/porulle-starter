...
import { getAvailableOptionValues } from "@/lib/commerce/encoded-variants";
...
function BuyButtonsFallback({
  ...
  return (
    <div className="grid grid-cols-2 gap-2.5">
      <div
        className={cn(
          "flex items-center justify-center rounded-lg h-12 border border-input text-sm font-medium",
