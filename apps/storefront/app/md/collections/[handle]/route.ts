...
import { getCollection } from "@/lib/commerce/operations/collections";
import {
...
export async function GET(request: Request, { params }: { params: Promise<{ handle: string }> }) {
  ...
  try {
    // /collections/all is a virtual "all products" route; mirror the HTML page's
    // data path so the same URL is legible to markdown-negotiating agents.
