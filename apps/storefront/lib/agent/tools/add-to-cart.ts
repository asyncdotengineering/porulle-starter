...
import { addToCart } from "@/lib/commerce/operations/cart";
...
If there are multiple variants (sizes, colors), ask the user which one they want before calling this tool.`,
    inputSchema: z.object({
      variant_id: z
        .string()
        .describe("The variant ID for the selected option. Get this from the product context or a getProductDetails result."),
