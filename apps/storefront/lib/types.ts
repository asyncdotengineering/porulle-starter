...
// These types are the contract between the data layer and components. The
// commerce operations transform backend responses into these domain types.
...
export interface ProductDetails extends ProductCard {
  ...
  /** Exact variant count; authoritative single-variant signal (=== 1). */
...
export interface ProductVariant {
  availableForSale: boolean;
  /** Bundle variants this variant is a component of; empty for non-components. */
  bundleParents: ProductVariantReference[];
  compareAtPrice?: Money;
  /** Fixed-bundle contents; empty unless this is a bundle variant. */
...
export interface CartLine {
  /** Edit instruction — false for a fixed bundle's component lines. */
  canRemove: boolean;
  /** Edit instruction — false for a fixed bundle's component lines. */
...
// Customer account types. Status fields hold raw backend enum values
